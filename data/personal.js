const sitePersonalInfo = {
    ...
    education: [
        {
            ...
            gpa: "GPA: 4.00/4.5 (Total), 4.18/4.5 (EECS), 4.25/4.5 (Math)",
    ...
    skills: {
        "AI & Machine Learning": ["Python", "PyTorch", "JAX", "Hugging Face", "WanDB", "Langchain", "R"],
        "Development & Systems": ["Linux", "Docker", "FastAPI", "Django", "PostgreSQL", "eBPF", "C++"]
    }
};